...
class AppColors {
  // Primary Shades (Blue)
  static const primaryForDarkThemeColor =  Color(0xFF0d6efd);   // Base Blue
  static const primaryColor =  Color(0xFF050065);   // Base Blue
