...
class EmployerManageJobsController extends StateNotifier<AppliedJobState> {

  EmployerManageJobsController() : super(AppliedJobState.initial()) {
    fetchData();
    selectFilter("All");
  }
  final List<JobModel> jobs = [
    JobModel(
      ...
      companyName: "Vedhasekaran and Akalya Inc 123",
      location: "Remote",
      experience: "1-4 yrs",
      salary: "3 - 6 Lacs PA",
