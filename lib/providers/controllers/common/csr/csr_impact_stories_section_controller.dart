...
class CsrImpactStoriesSectionController extends StateNotifier<CsrImpactState> {
  final CsrService _service = CsrService();

  CsrImpactStoriesSectionController() : super(CsrImpactState.initial()) {
    fetchData();
  }
  ...
  Future<void> fetchData() async {
    ...
    try {
      final result = await _service.getCsrImpactStoriesData();
      ...
      debugPrint(" catch CsrImpactStoriesSectionController  fetchData -${e.toString()}");
