...
class LgbtqQuoteSection2Controller extends StateNotifier<LgbtqQuoteState> {
  final LgbtqService _service = LgbtqService();

  LgbtqQuoteSection2Controller() : super(LgbtqQuoteState.initial()) {
    fetchData();
  }
  ...
  Future<void> fetchData() async {
    ...
    try {
      final result = await _service.lgbtqQuotes2();
      ...
      debugPrint(" catch lgbtqQuotes2  fetchData -${e.toString()}");
