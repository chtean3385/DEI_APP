...
import '../../../models/state_models/saved/saved_job_state.dart';

class SavedJobsController extends StateNotifier<SavedJobState> {

  SavedJobsController() : super(SavedJobState.initial()) {
    fetchData();
  }
  ...
  Future<void> fetchData() async {
    ...
    try {
      ...
      debugPrint(" catch SavedJobsController  fetchData -${e.toString()}");
