...
class CandidateContactDetails extends ConsumerWidget {
  const CandidateContactDetails({super.key});
        ...
        children: [
          Row(
            children: [
              ...
              ViewAllButton(showArrow: true,text:"View Resume" ,isSmall: true,padding: EdgeInsets.symmetric(horizontal: 0,vertical: 0),onPressed: ()=>controller.downloadResumeFromUrl(),),
            ],
          ),
