...
class GenZAdvantages extends ConsumerStatefulWidget {
  const GenZAdvantages( {Key? key}) : super(key: key);

  @override
  ConsumerState<GenZAdvantages> createState() => _JobsServiceSectionState();
}

class _JobsServiceSectionState extends ConsumerState<GenZAdvantages> {
  ...
  Widget build(BuildContext context) {
    final state = ref.watch(genZAdvantagesSectionControllerProvider);
  ...
  Widget _dataItems(GenZAdvantagesState state) {
  ...
  Widget _buildCard(GenZCardModel card) {
