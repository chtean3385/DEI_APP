...
class LgbtqAdvantages extends ConsumerStatefulWidget {
  const LgbtqAdvantages({Key? key}) : super(key: key);

  @override
  ConsumerState<LgbtqAdvantages> createState() => _JobsServiceSectionState();
}

class _JobsServiceSectionState extends ConsumerState<LgbtqAdvantages> {
  ...
  Widget build(BuildContext context) {
    final state = ref.watch(lgbtqAdvantagesController);
  ...
  Widget _dataItems(LgbtqAdvantagesState state) {
