...
class LgbtqInclusionSection extends ConsumerStatefulWidget {
  const LgbtqInclusionSection({Key? key}) : super(key: key);

  @override
  ConsumerState<LgbtqInclusionSection> createState() => _JobsServiceSectionState();
}

class _JobsServiceSectionState extends ConsumerState<LgbtqInclusionSection> {
  ...
  Widget build(BuildContext context) {
    final state = ref.watch(lgbtqInclusionPointsProvider);
  ...
  Widget _dataItems(LgbtqInclusionPointState state) {
    final data = state.data?.first.inclusionItems ?? [];
  ...
  Widget _buildCard(InclusionItemModel card) {
