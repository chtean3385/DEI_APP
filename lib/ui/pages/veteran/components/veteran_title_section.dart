...
class VeteranTitleSection extends ConsumerWidget {
  const VeteranTitleSection({super.key});

  @override
  Widget build(BuildContext context, WidgetRef ref) {
    final state = ref.watch(veteranTitleSectionProvider);
        ...
        children: [
          ...
          Padding(
            ...
            child: Column(
              ...
              Row(
                  children: [
                    if(item.btn1Label?.isNotEmpty == true)   Padding(
                      ...
                      child: CustomThemeButton(
                        ...
                        child: Row(
                          ...
                          children: [
                            Text(
                              item.btn1Label ?? "", // assuming CtaModels has a text property
                              style: context.textTheme.displaySmall?.copyWith(
                                color:  Colors.white,
                                fontSize: 11,
                              ),
                    ...
                    if(item.btn2Label?.isNotEmpty == true)  Row(
                      children: [
                        Padding(
                          padding: EdgeInsets.only(right: 12), // spacing between buttons
                          child: CustomThemeButton(
                            ...
                            child: Row(
                              ...
                              children: [
                                Text(
                                  item.btn2Label ?? "", // assuming CtaModels has a text property
                                  style: context.textTheme.displaySmall?.copyWith(
                                    color:   Colors.black,
                                    fontSize: 11,
                                  ),
